...
export const BentoGridItem = ({
  ...
  const rightLists = ["Express", "PostgreSQL", "GSAP"];
  //TODO: Adjust skills set 
  //  OR also TailwindCSS and Python

  const [copied, setCopied] = useState(false)
  const [animationKey, setAnimationKey] = useState(0);

  const handleCopy = () => {
    navigator.clipboard.writeText('Marija.Krotova.dev@gmail.com');
    setCopied(true);
